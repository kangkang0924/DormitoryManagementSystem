<template>
  ...
  >
    ...
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="4">
      ...
      <el-menu-item v-if="this.judgeIdentity()===2||1" index="/noticeInfo">公告信息</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()===2||1" index="/scoreInfo">宿舍评分</el-menu-item>
    ...
    <el-menu-item v-if="this.judgeIdentity()===0" index="/applyScoreInfo">
      <el-icon>
        <Tickets />
      </el-icon>
      <span>宿舍评分</span>
