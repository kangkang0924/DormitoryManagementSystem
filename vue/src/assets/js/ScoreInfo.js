    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                repairer: [
                    {required: true, message: "请输入评分人", trigger: "blur"},
                ],
                orderBuildTime: [
        ...
        save() {
            this.$refs.form.validate(async (valid) => {
                if (valid) {
                    if (this.judge === false) {
                        //新增
                        await request.post("/score/add", this.form).then((res) => {
                            console.log(res);
                            if (res.code === "0") {
                                ElMessage({
                                    message: "新增成功",
                        ...
                        //修改
                        await request.put("/score/update", this.form).then((res) => {
                            console.log(res);
                            if (res.code === "0") {
                                ElMessage({
                                    message: "修改成功",
