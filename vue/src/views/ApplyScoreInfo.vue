...
<!--              </el-tooltip>-->
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column :show-overflow-tooltip="true" label="评分分数" prop="title"/>
          ...
          <el-table-column label="申请人" prop="scoreer" width="150px"/>
<!--          <el-table-column-->
        ...
        <div>
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="宿管员" prop="scoreer">
                <el-input v-model="form.scoreer" disabled style="width: 80%">{{ this.name }}</el-input>
              </el-form-item>
...
<script src="@/assets/js/ApplyScoreInfo.js"></script>