    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column :show-overflow-tooltip="true" label="分数" prop="title"/>
          ...
          <el-table-column label="评分人" prop="scoreer" width="150px"/>
<!--          <el-table-column-->
...
<!--            </template>-->
<!--          </el-table-column>-->
          <el-table-column label="评分时间" prop="orderBuildTime" sortable/>
        ...
        <div>
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              <el-form-item label="评分" prop="title" style="margin-bottom: 27px">
              ...
              <el-form-item label="评分人" prop="scoreer">
                <el-input v-model="form.scoreer" clearable style="width: 50%"></el-input>
              </el-form-item>
...
<!--              </el-form-item>-->
              <el-form-item label="评分时间" prop="orderBuildTime" style="margin-top: 27px">
                <el-date-picker
...
<script src="@/assets/js/ScoreInfo.js"></script>